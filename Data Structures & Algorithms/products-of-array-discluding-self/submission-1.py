...
# logic is nice: 2*4*6//2 =4*6 but need to handle zero case, jupyter madhe aahe hey 
def productExceptSelf(self, nums):
      total = 1
      for x in nums:
          total *= total_product         # product of ALL elements
      return [total // nums[i] for i in range(len(nums))]   # divide out each element
